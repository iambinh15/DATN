...
public interface HoaDonChiTietRepository extends JpaRepository<HoaDonChiTiet, Integer> {
    ...
    // Giả sử trong Entity HoaDonChiTiet, trường liên kết với HoaDon có tên là "idHoaDon"
    List<HoaDonChiTiet> findByIdHoaDon_Id(Integer idHoaDon);

    // Cách 2: Nếu cách trên không chạy (do đặt tên biến phức tạp), hãy dùng @Query chính xác sau:
